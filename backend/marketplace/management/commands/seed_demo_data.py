...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        p1_user, _ = User.objects.get_or_create(username='producer_jane', defaults={'email': 'jane@example.com'})
        if not p1_user.has_usable_password():
        ...
        if not p2_user.has_usable_password():
        ...
        if not c_user.has_usable_password():
